      ...
      <form onSubmit={handleSubmit(onSave)} className="space-y-6">
        <Card>
          ...
          <CardContent>
            ...
            />
            {errors.serviceTypes && (
              <p className="text-sm text-red-500 mt-2">{errors.serviceTypes.message}</p>
            )}
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Service mode & location</CardTitle>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Service suburbs</CardTitle>
          </CardHeader>
          <CardContent>
            <Controller
              name="suburbs"
            ...
            />
            {errors.suburbs && (
              <p className="text-sm text-red-500 mt-2">{errors.suburbs.message}</p>
            )}
          </CardContent>
        </Card>
