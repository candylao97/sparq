...
const STEPS = ['service', 'location', 'listing', 'experience', 'qualifications'] as const
...
export default function ProviderRegisterPage() {
  ...
  const handleFinish = async () => {
    ...
    try {
      ...
      toast.success('Welcome! Your listing is live.')
      ...
      {aboutStepNum > 0 ? (
        <div className="flex items-center justify-between border-b border-[#e8e1de] px-6 py-4">
          ...
          <div className="text-center">
            <span className="text-sm font-semibold text-[#1A1A1A]">About you</span>
      ...
      <div className="flex flex-1 items-center justify-center px-4 py-10">
        ...
        {step === 'service' && (
          <div className="w-full max-w-4xl">
            <h1 className="mb-10 text-center text-3xl font-bold text-[#1A1A1A] sm:text-4xl">
                ...
                <button
                  ...
                  className={`flex flex-col items-center rounded-2xl border-2 p-5 transition-all hover:shadow-md ${
                    selectedService?.id === service.id
                      ? 'border-gray-900 bg-[#f9f2ef] shadow-md'
            ...
            <div className="flex-1">
              ...
              <div className="relative max-w-md">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-[#1A1A1A]/15 py-4 pl-12 pr-4 text-sm text-[#1A1A1A] placeholder-[#717171] outline-none focus:border-gray-900 focus:ring-1 focus:ring-gray-900"
                  autoFocus
                />
              </div>
            </div>
        ...
        {step === 'experience' && (
          <div className="text-center">
            <h1 className="mb-12 text-3xl font-bold text-[#1A1A1A] sm:text-4xl">
            ...
            <div className="flex items-center justify-center gap-6">
              <button
                ...
                className="flex h-12 w-12 items-center justify-center rounded-full border border-[#1A1A1A]/15 text-[#717171] transition-colors hover:border-gray-900 hover:text-[#1A1A1A] disabled:opacity-30"
                disabled={years <= 1}
              >
              ...
              <button
                ...
                className="flex h-12 w-12 items-center justify-center rounded-full border border-[#1A1A1A]/15 text-[#717171] transition-colors hover:border-gray-900 hover:text-[#1A1A1A]"
              >
        ...
        {step === 'qualifications' && (
          <div className="w-full max-w-lg text-center">
            ...
            <h1 className="mb-2 text-3xl font-bold text-[#1A1A1A] sm:text-4xl">
              ...
              {expandedQual === 'experience' && (
                <div className="ml-16 mr-4">
                  <textarea
                    ...
                    rows={3}
                    className="w-full rounded-xl border border-[#1A1A1A]/15 px-4 py-3 text-sm text-[#1A1A1A] placeholder-[#717171] outline-none focus:border-gray-900"
                    autoFocus
                  />
                </div>
              )}
        ...
        <div className="mx-auto flex max-w-4xl items-center justify-between">
          ...
          {step === 'qualifications' ? (
            <Button
              ...
              loading={loading}
              size="lg"
              className="!rounded-xl !bg-[#1A1A1A] !px-8 !text-white hover:!bg-[#1A1A1A]"
            >
              Finish
            </Button>
          ) : (
            <button
              ...
              onClick={goNext}
              disabled={!canProceed()}
              className="rounded-xl bg-[#1A1A1A] px-8 py-3.5 text-sm font-semibold text-white transition-colors hover:bg-[#1A1A1A] disabled:opacity-30"
            >
              Next
            </button>
          )}
